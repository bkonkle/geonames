...
class PsycoPg2Importer(GeonamesImporter):
    ...
    def insert_dummy_records(self):
        ...
        print self.cursor.execute("DELETE FROM country WHERE geoname_id=6295630 or iso_numeric=-1")
        print self.cursor.execute("DELETE FROM continent WHERE geoname_id=6295630")
